...
public class ExcavatorServiceTest {
	...
	public void testGetOutputRate_01() {
		...
		String sheetName = Constants.LOCATION_ONE;
		Double outputRate = ExcavatorService.getOutputRate(path, sheetName, beginDateString, endDateString);
	...
	public void testGetGrossProfit_01() {
		...
		String sheetName = Constants.LOCATION_THREE;
		Double grossProfit = ExcavatorService.getGrossProfit(path, sheetName, beginDateString, endDateString);
	...
	public void testGetGrossProfitByLocation_01() {
		...
		String sheetName = Constants.LOCATION_THREE;
		Double grossProfit = ExcavatorService.getGrossProfitByLocation(path, sheetName, location);
	...
	public void testGetAverageGrossProfitByLocation_01() {
		...
		String location = Constants.LOCATION_ONE;
		String sheetName = Constants.LOCATION_THREE;
		Double grossProfit = ExcavatorService.getAverageGrossProfitByLocation(path, sheetName, location);
		logger.debug(location + "grossProfit\t" + grossProfit);
	}
	...
	public void testGetNetProfit_01() {
		...
		String endDateString = "2017-04-30";
		String sheetName = Constants.LOCATION_THREE;
		Double netProfit = ExcavatorService.getNetProfit(path, sheetName, beginDateString, endDateString);
	...
	public void testGetAverageDailyGrossIncome_01() {
		...
		String endDateString = "2017-04-30";
		String sheetName = Constants.LOCATION_THREE;
		Double averageDailyGrossIncome = ExcavatorService.getAverageDailyGrossIncome(path, sheetName, beginDateString,
				endDateString);
	...
	public void testGetSettlingChargeByLocation_01() {
		...
		String location = Constants.LOCATION_ONE;
		String sheetName = Constants.LOCATION_THREE;
		Map<String, Double> settlingChargeMap = ExcavatorService.getSettlingChargeByLocation(path, sheetName, location);
	...
	public void testGetSettlingChargeAmountByLocation_01() {
		...
		String location = Constants.LOCATION_ONE;
		String sheetName = Constants.LOCATION_THREE;
		Map<String, String> settlingChargeMap = ExcavatorService.getSettlingChargeAmountByLocation(path, sheetName,
				location);
